...
export async function fetchCoordinates(city, state) {
  ...
  const response = await fetch(
    `https://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/findAddressCandidates?City=${city}&Region=${state}&countryCode=USA&maxLocations=1&outFields=address,location&f=pjson`
  );
